...
x = 0
y = 0
dif = 500 / 9  # use to grid horizontal lines
val = 0
# Default Sudoku Board.


grid = sudoku().default_board()
# OMG!!!!! 用sudoku().make_board() 就可以由另一個file refer list!!!!
    ...
    for i in range(9):
        for j in range(9):
            if grid[i][j] != 0:
                ...
                screen.blit(text1, (i * dif + 5, j * dif + 5))
